...
(function() {
  jQuery(function() {
    var oTable;
    return oTable = $('#listado1').dataTable()({
      sPaginationType: "bootstrap"
    }, new AutoFill(oTable));
  });
...
(function() {
  jQuery(function() {
    var lugares, modulos, otros, proyectos, responsables1, responsables2;
    ...
    $('#tarea_otro_id').empty();
    return $('#tarea_cliente_id').change(function() {
      var cliente, opciones1, opciones2, opciones3, opciones4, opciones5, opciones6;
      ...
      if (opciones2 || opciones4 || opciones5 || opciones1 || opciones3 || opciones6) {
        ...
        return $('#tarea_otro_id').html(opciones6);
      } else {
        $('#tarea_proyecto_id').empty();
        $('#tarea_lugar_id').empty();
        $('#tarea_modulo_id').empty();
