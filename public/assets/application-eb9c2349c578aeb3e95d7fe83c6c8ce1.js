...
(function() {
  jQuery(function() {
    var lugares, modulos, proyectos, responsables1, responsables2;
    ...
    return $('#tarea_cliente_id').change(function() {
      var cliente, opciones1, opciones2, opciones3, opciones4, opciones5;
      ...
      if (opciones2 || opciones4 || opciones5 || opciones1 || opciones3) {
        ...
        return $('#tarea_responsable_planta_id').html(opciones5);
      } else {
        $('#tarea_proyecto_id').empty();
        $('#tarea_lugar_id').empty();
        $('#tarea_modulo_id').empty();
        $('#tarea_responsable_sistema_id').empty();
        return $('#tarea_responsable_planta_id').empty();
      }
    });
  });
