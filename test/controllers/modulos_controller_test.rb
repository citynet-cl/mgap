...
class ModulosControllerTest < ActionController::TestCase
  ...
  test "should create modulo" do
    assert_difference('Modulo.count') do
      post :create, modulo: { descripcion: @modulo.descripcion, nombre: @modulo.nombre, proyecto_id: @modulo.proyecto_id }
    end
  ...
  test "should update modulo" do
    patch :update, id: @modulo, modulo: { descripcion: @modulo.descripcion, nombre: @modulo.nombre, proyecto_id: @modulo.proyecto_id }
    assert_redirected_to modulo_path(assigns(:modulo))
  end
