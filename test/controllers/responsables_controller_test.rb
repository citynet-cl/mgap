...
class ResponsablesControllerTest < ActionController::TestCase
  ...
  test "should create responsable" do
    assert_difference('Responsable.count') do
      post :create, responsable: { email: @responsable.email, fono: @responsable.fono, lugar_id: @responsable.lugar_id, nombre: @responsable.nombre }
    end
  ...
  test "should update responsable" do
    patch :update, id: @responsable, responsable: { email: @responsable.email, fono: @responsable.fono, lugar_id: @responsable.lugar_id, nombre: @responsable.nombre }
    assert_redirected_to responsable_path(assigns(:responsable))
  end
